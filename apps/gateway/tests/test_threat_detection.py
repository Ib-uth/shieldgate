...
from ..utils.ml_utils import ThreatDetectionModel, generate_synthetic_training_data, train_threat_detection_model
...
class TestThreatDetectionModel:
    ...
    def test_feature_extraction(self):
        ...
        assert features.endpoint_category in ["public", "user", "admin", "health", "metrics", "unknown"]
    ...
    def test_synthetic_data_generation(self):
        ...
        required_fields = ["ip_request_count", "user_agent_entropy", "hour_of_day", 
                          "endpoint_category", "request_size", "header_count"]
