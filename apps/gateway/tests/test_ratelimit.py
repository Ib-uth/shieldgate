...
from ..middleware.ratelimit import RedisRateLimiter, RateLimitMiddleware
...
class TestRedisRateLimiter:
    ...
    async def test_ip_rate_limit_exceeded(self):
        ...
        self.redis_mock.zrange.return_value = [(b"test", time.time() - 30)]  # 30 seconds ago
    ...
    async def test_redis_error_handling(self):
        ...
        self.redis_mock.zremrangebyscore.side_effect = Exception("Redis connection failed")
    ...
    async def test_get_rate_limit_stats(self):
        ...
        stats = await self.rate_limiter.get_rate_limit_stats("rate_limit:ip:192.168.1.1")
...
class TestRateLimitMiddleware:
    ...
    def test_rate_limit_headers_added(self, mock_redis):
        ...
        with patch('apps.gateway.main.RedisRateLimiter', return_value=mock_rate_limiter):
